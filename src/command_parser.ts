...
// @ts-ignore
  ...
  var peg$f0 = function(label, args) {
// @ts-ignore
    return {
// @ts-ignore
      label,
// @ts-ignore
  ...
  var peg$f1 = function(head, tail) {// @ts-ignore
 return head + tail.join('') };// @ts-ignore
...
// @ts-ignore
    if (s2 !== peg$FAILED) {
// @ts-ignore
      s3 = peg$parseCommandLabel();
// @ts-ignore
      if (s3 !== peg$FAILED) {
// @ts-ignore
        s4 = [];
// @ts-ignore
        s5 = peg$parseCommandArgument();
// @ts-ignore
        while (s5 !== peg$FAILED) {
// @ts-ignore
          s4.push(s5);
...
export type ParseFunction = <Options extends ParseOptions>(
    ...
    StartRule extends "Script" ? Script : Script
    : Script;
...
export type Command = { label: CommandLabel; args: CommandArgument[] };
export type CommandLabel = string;
export type CommandArgument = Number_1 | String_1;
export type String_1 = DoubleQuotedString | SingleQuotedString | PlainString;
export type DoubleQuotedString = string;
export type SingleQuotedString = string;
